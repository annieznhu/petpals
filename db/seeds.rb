...
dog_9 = Dog.create!(user: user_9 ,name: 'Aria', age: '9', species: 'Yorkshire', temper: 'Amical', address: '3 Rue Frédéric Loliée, 75020 Paris', description: 'Petite princesse, je n’ai aucun mal à approcher mes semblables', toys: ['Bâtons', 'Papier'])
